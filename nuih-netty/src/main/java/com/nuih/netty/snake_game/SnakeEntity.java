...
public class SnakeEntity {
    ...
    private ArrayList<Integer[]> bodys = new ArrayList<Integer[]>();//y,x
    private ArrayList<Integer[]> addNodes = new ArrayList<Integer[]>(); // 当前地图上添加的临时节点
    private ArrayList<Integer[]> removeNodes = new ArrayList<Integer[]>();//当前地图上移除的临时节点
