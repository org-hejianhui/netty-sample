...
public class SnakeGameEngine {
    ...
    public Map<String, SnakeEntity> snakes = new HashMap<String, SnakeEntity>();
...
//                    snake.moveStep();
        ...
        // 当前版本 新增的节点
        ArrayList<Integer[]> changeNodes = new ArrayList<Integer[]>();
    ...
    private List<SnakeEntity> getSnakeByNode(Integer[] node) {
        List<SnakeEntity> result = new ArrayList<SnakeEntity>();
...
//            logger.warn("找不到指定帐户");
    ...
    public ArrayList<Integer[]> getAllPoint() {
        ArrayList<Integer[]> allPoints = new ArrayList<Integer[]>(2000);
        Integer x, y;
    ...
    public List<IntegralInfo> getRankingList() {
        List<IntegralInfo> result = new ArrayList<IntegralInfo>(10);
        List<SnakeEntity> list = new ArrayList<SnakeEntity>(snakes.size());
